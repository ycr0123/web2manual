...
In settings.json, add this to run the hook before every Bash command:
...
The hook calls a script which checks if the command is a test runner and modifies it to show only failures:
