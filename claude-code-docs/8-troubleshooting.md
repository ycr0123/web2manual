...
1. **Open Environment Variables**: Press `Win + R`, type `sysdm.cpl`, and press Enter. Click **Advanced** → **Environment Variables**.

2. **Edit User PATH**: Under "User variables", select **Path** and click **Edit**. Click **New** and add:
   ```
...
If you notice code blocks without language tags:
